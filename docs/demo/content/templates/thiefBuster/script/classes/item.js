...
var Item = /** @class */ (function () {
    ...
    function Item(_scene, _parent) {
        ...
        for (var i = 0; i < this.animeTypes.length; ++i) { // アイテムアニメ管理用配列 代入
            // 初期化しないとエラーになる
            this.animeTypes[i] = {
                in: "",
                get: "",
            ...
            for (var j = 0; j < NUM_OF_ITEM_ANIME; ++j) { // アニメ種類ループ
     ...
     */
    Item.prototype.handleUpdate = function () {
    ...
    Item.prototype.popItem = function (_level) {
        ...
        var pos = {
            x: Math.floor(this.game.random.generate() * (define_1.define.POS_ITEM_POP_X_MAX - define_1.define.POS_ITEM_POP_X_MIN) + define_1.define.POS_ITEM_POP_X_MIN),
