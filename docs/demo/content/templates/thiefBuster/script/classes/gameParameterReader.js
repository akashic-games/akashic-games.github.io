...
exports.GameParameterReader = void 0;
...
var GameParameterReader = /** @class */ (function () {
    ...
    GameParameterReader.loadFromJson = function (_scene) {
        var difficultyJson = _scene.asset.getJSONContentById(miscAssetInfo_1.MiscAssetInfo.difficultyData.name);
        ...
        if (difficultyList[index].embedNumber) {
            this.thiefPopRates = [];
            var length = difficultyList[index].embedNumber.length;
