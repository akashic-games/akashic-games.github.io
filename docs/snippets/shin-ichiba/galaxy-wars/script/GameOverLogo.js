...
class GameOverLogo {
    constructor() {
        ...
        const gameOverImageAsset = Global_1.Global.gameCore.scene.asset.getImage("/image/gameover.png");
        this.spr = new g.E({
    ...
    glitch() {
        const pulse = {
            ...
            pos: Math.floor(Global_1.Global.gameCore.scene.asset.getImage("/image/gameover.png").height * math.random()),
