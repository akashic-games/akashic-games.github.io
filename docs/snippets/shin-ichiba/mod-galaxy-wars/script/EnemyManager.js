...
const SelfDestructionEnemy_1 = require("./SelfDestructionEnemy");
class EnemyManager {
    constructor() {
        this.cntr = 0;
    }
    ...
    update() {
        if (this.cntr === g.game.fps * 3) { // tutorial 1
            ...
            for (let i = 0; i < 4; i++) {
                Global_1.Global.gameCore.entities.push(new SelfDestructionEnemy_1.SelfDestructionEnemy());
            }
        }
            ...
            if (enemyCount < 2 || (enemyCount < 5 && math.random() < 0.5)) {
                ...
                if (rnd < 0.05) {
                    ...
                    enemy = new SelfDestructionEnemy_1.SelfDestructionEnemy();
                }
                if (enemy) {
