...
declare module '@akashic/trigger/ChainTriggerLike' {
    import type { TriggerLike } from "@akashic/trigger/TriggerLike";
...
declare module '@akashic/trigger/Trigger' {
    import type { HandlerFunction, TriggerHandler, TriggerAddParameters, TriggerRemoveConditions, TriggerSearchConditions, TriggerLike } from "@akashic/trigger/TriggerLike";
    /**
        * イベント通知機構クラス。
        */
...
declare module '@akashic/trigger/ChainTrigger' {
    import type { ChainTriggerLike, ChainTriggerFilterFunction } from "@akashic/trigger/ChainTriggerLike";
    import { Trigger } from "@akashic/trigger/Trigger";
    import type { TriggerLike, TriggerRemoveConditions, HandlerFunction, TriggerAddParameters } from "@akashic/trigger/TriggerLike";
    /**
        * 他のTriggerLikeに反応して発火するイベント通知機構。
        */
