...
declare module '@akashic/pdi-types' {
    ...
    export * from "@akashic/pdi-types/platform/RendererCandidate";
...
declare module '@akashic/pdi-types/surface/CompositeOperationString' {
    /**
      ...
      */
    export type CompositeOperationString = "source-over" | "source-atop" | "lighter" | "copy" | "experimental-source-in" | "experimental-source-out" | "experimental-destination-atop" | "experimental-destination-in" | "destination-out" | "destination-over" | "xor" | "difference" | "saturation";
}
...
declare module '@akashic/pdi-types/platform/RendererCandidate' {
...
declare module '@akashic/pdi-types/platform/RendererRequirement' {
    import type { RendererCandidate } from "@akashic/pdi-types/platform/RendererCandidate";
    /**
        * Rendererへの要求事項。
        */
