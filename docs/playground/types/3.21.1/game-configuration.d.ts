...
declare module '@akashic/game-configuration' {
    ...
    export * from "@akashic/game-configuration/AssetBundleConfiguration";
...
declare module '@akashic/game-configuration/AssetBundleConfiguration' {
    import type { ScriptAssetRuntimeValue } from "@akashic/pdi-types";
    import type { ScriptAssetConfigurationBase, TextAssetConfigurationBase } from "@akashic/game-configuration/AssetConfiguration";
...
declare module '@akashic/game-configuration/GameConfiguration' {
    ...
    import type { AssetConfiguration, AssetConfigurationMap, AudioSystemConfigurationMap, ModuleMainPathsMap, ModuleMainScriptsMap } from "@akashic/game-configuration/AssetConfiguration";
