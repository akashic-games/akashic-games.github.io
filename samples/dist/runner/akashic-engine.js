...
(function (g) {
    ...
    (function (EventType) {
         ...
         * この値は利用されていない。
         */
        EventType[EventType["Seed"] = 3] = "Seed";
        /**
         * ポイントダウンイベント。
         */
        EventType[EventType["PointDown"] = 4] = "PointDown";
        /**
         * ポイントムーブイベント。
         */
        EventType[EventType["PointMove"] = 5] = "PointMove";
        /**
         * ポイントアップイベント。
         */
        EventType[EventType["PointUp"] = 6] = "PointUp";
        /**
         * 汎用的なメッセージを表すイベント。
         */
        EventType[EventType["Message"] = 7] = "Message";
        /**
        ...
        Label.prototype._invalidateSelf = function () {
            ...
            for (var i = 0; i < this.text.length; ++i) {
                ...
                if (!glyph) {
                    ...
                    throw g.ExceptionFactory.createAssertionError("Label#_invalidateSelf(): failed to get a glyph for '" + str + "' " +
