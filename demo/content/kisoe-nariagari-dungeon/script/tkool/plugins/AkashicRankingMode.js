...
(function () {
    ...
    var MAX_VOLUME = 100;
    var MIN_VOLUME = 0;
    var musicVolume = core_1.Utils.clamp(Number(parameters.musicVolume || MAX_VOLUME), MIN_VOLUME, MAX_VOLUME);
    var soundVolume = core_1.Utils.clamp(Number(parameters.soundVolume || MAX_VOLUME), MIN_VOLUME, MAX_VOLUME);
    // ゲームスコア用のウィンドウを用意
    // 参考: Window_Gold クラス
