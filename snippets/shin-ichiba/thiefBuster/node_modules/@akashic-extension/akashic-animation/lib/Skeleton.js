...
var Skeleton = /** @class */ (function () {
     ...
     * エフェクトのリセット
     */
    Skeleton.prototype.resetEffect = function () {
        for (var i = 0; i < this.composedCaches.length; i++) {
            var effects = this.composedCaches[i].effects;
     ...
     * デバッグ用
     */
    Skeleton.prototype._startEffect = function () {
        for (var i = 0; i < this.caches.length; i++) {
            var effects = this.caches[i].effects;
            for (var j = 0; j < effects.length; j++) {
     ...
     */
    Skeleton.prototype.update = function (time, anim, dt) {
    ...
    Skeleton.prototype._handleUserEvent = function (startFrame, elapse, anim) {
        for (var i = 0; i < this._triggeringBones.length; i++) {
            ...
            for (var j = 0; j < ct.curves.length; j++) { // curve(=attribute) loop
    ...
    Skeleton.prototype.updateCache = function (time, anim) {
        for (var i = 0; i < this.bones.length; i++) { // bone loop
    ...
    Skeleton.prototype.updateEffect = function (dt) {
        for (var i = 0; i < this.composedCaches.length; i++) {
            var cc = this.composedCaches[i];
            var effects = cc.effects;
            var effectValue = cc.attrs[AttrId.effect];
            if (!effectValue)
                continue;
            for (var j = 0; j < effects.length; j++) {
                var ps = effects[j].particleSystem;
