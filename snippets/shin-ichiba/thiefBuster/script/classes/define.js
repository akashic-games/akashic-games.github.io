...
(function (define) {
  ...
  /** ステージ配置位置 */
  define.POS_STAGE = {
    x: 66 + define.OFFSET_X,
    y: 14
  };
  /** ステージ右端ビル配置位置 */
  define.POS_STAGE_SIDE = {
    x: 555,
    y: -30
  };
  /** 最上段ドア左上 */
  define.POS_DOOR = {
    x: 120 + define.OFFSET_X,
    y: 77
  };
  /** ドア幅 */
  ...
  define.WKMAN_ATTACH_POS_ATTACK = {
    x: 40,
    y: 45
  };
  /** 弾レベル */
  ...
  /** アイテム出現位置Yリスト */
  define.POS_ITEM_POP_LIST_Y = [134, 234, 334];
  // 泥棒
  /** 泥棒種類 */
  var ThiefType;
  (function (ThiefType) {
  ...
  /** 泥棒出現位置Yリスト */
  define.POS_THIEF_POP_LIST_Y = [160, 260, 360];
  /** 泥棒アニメ短縮 */
  ...
  /** 初期値配列 */
  define.THIEF_VALUES = [define.SHORT_VALUE, define.TALL_VALUE, define.GRANDE_VALUE];
  /** 泥棒出現レート */
  define.THIEF_POP_RATES = [{
    ...
    list: [ThiefType.short, ThiefType.short, ThiefType.short, ThiefType.short, ThiefType.short]
  }, {
    phase: 2,
    popInterval: 45,
    floor: [{
    ...
    list: [ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall]
  }, {
    phase: 3,
    popInterval: 45,
    floor: [{
    ...
    list: [ThiefType.grande, ThiefType.grande, ThiefType.grande, ThiefType.grande, ThiefType.grande]
  }, {
    phase: 4,
    popInterval: 30,
    floor: [{
    ...
    list: [ThiefType.short, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.grande]
  }, {
    phase: 5,
    popInterval: 22,
    floor: [{
    ...
    list: [ThiefType.short, ThiefType.short, ThiefType.short, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.grande, ThiefType.grande]
  }, {
    phase: 6,
    popInterval: 22,
    floor: [{
    ...
    list: [ThiefType.short, ThiefType.short, ThiefType.short, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.grande, ThiefType.grande, ThiefType.grande]
  }, {
    phase: 7,
    popInterval: 15,
    floor: [{
    ...
    list: [ThiefType.short, ThiefType.short, ThiefType.short, ThiefType.short, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.grande, ThiefType.grande, ThiefType.grande, ThiefType.grande]
  }, {
    phase: 8,
    popInterval: 15,
    floor: [{
    ...
    list: [ThiefType.short, ThiefType.short, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.grande, ThiefType.grande, ThiefType.grande, ThiefType.grande, ThiefType.grande]
  }, {
    phase: 9,
    popInterval: 15,
    floor: [{
    ...
    list: [ThiefType.short, ThiefType.short, ThiefType.short, ThiefType.short, ThiefType.short, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.grande, ThiefType.grande]
  }, {
    phase: 10,
    popInterval: 13,
    floor: [{
    ...
    list: [ThiefType.short, ThiefType.short, ThiefType.short, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.tall, ThiefType.grande, ThiefType.grande, ThiefType.grande, ThiefType.grande, ThiefType.grande]
  }];
  /** 基本スコア */
